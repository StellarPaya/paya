 ...
 * @dev Cross-chain bridge contract for Ethereum network with atomic swap support
 * 
 * This contract enables atomic cross-chain swaps between Ethereum and other blockchain networks.
 ...
 * - Support for ERC-20 tokens and native ETH
 * - Emergency pause mechanism
 * - Fee management and distribution
 * - Cross-chain message passing integration
 */
contract EthereumBridge is ReentrancyGuard, Pausable, Ownable {
    ...
    constructor(uint256 _feeBasisPoints) Ownable(msg.sender) {
        ...
        // Add native ETH as supported (address(0))
